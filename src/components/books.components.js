...
import {Button, Grid, ListItem, TextField, withStyles} from "@material-ui/core";
...
class BooksList extends Component {
    ...
    searchTitle() {
        BooksDataService.findByTitle(this.state.searchTitle)
            .then(response => {
                this.setState({
                    tutorials: response.data
                });
                ...
                <Grid container>
                    ...
                    <Grid item md={8}>
                        {currentTutorial ? (
                            ...
                            <div>
                                <br/>
                                <p className={classes.tutorial}>Please click on Books...</p>
                            </div>
                        )}
                    </Grid>
                </Grid>
